package guibedin.alura7days.day3.jackson;
...
public class Day3Jackson {
    ...
    public static void execute() throws Exception {
        ...
        List<MovieJackson> movies = objectMapper.readValue(moviesJson, new TypeReference<List<MovieJackson>>() {});
